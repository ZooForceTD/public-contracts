...
import "./HabitatMinteableERC721.sol";
...
contract HabitatCore is HabitatMinteableERC721, AccessControl, Ownable, IZooForceNFTCore {
    ...
    constructor(address _presale)
        ERC721Metadata("Habitat","ZFHABITAT")
        public{
    ...
    /// @notice Returns all the relevant information about a specific Habitat.
    /// @param _id The ID of the Habitat of interest.
    function getHabitat(uint256 _id)
        public
        view
        returns (uint256 birthMoment, uint256 natureCode){
        Habitat storage habitat = Habitats[_id - 1];

        birthMoment = uint256(habitat.birthMoment);
        natureCode = habitat.natureCode;
    }
